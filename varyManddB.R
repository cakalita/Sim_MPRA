...
#simRepAse201 <- simSimple1(prop=RNA_prop,M=100,N=round((dd$R+dd$A)/5+1))
#simRepAse202 <- simSimple1(prop=RNA_prop,M=100,N=round((dd$R+dd$A)/5+1))
#simRepAse203 <- simSimple1(prop=RNA_prop,M=100,N=round((dd$R+dd$A)/5+1))
#simRepAse204 <- simSimple1(prop=RNA_prop,M=100,N=round((dd$R+dd$A)/5+1))
#simRepAse205 <- simSimple1(prop=RNA_prop,M=100,N=round((dd$R+dd$A)/5+1))
